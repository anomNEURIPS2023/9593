...
AGENT_TRAIN_FORMAT = {
    'sac': [
        ...
        ('actor_grad_norm','ANORM','float'),
        ('critic_grad_norm','CNORM','float'),
    ]
}

pseudo_AGENT_TRAIN_FORMAT = {
    'sac_venv': [
        ('batch_reward', 'BR', 'float'),
        ('actor_loss', 'ALOSS', 'float'),
        ('critic_loss', 'CLOSS', 'float'),
...
class Logger(object):
    def __init__(self,
        ...
        if agent in AGENT_TRAIN_FORMAT:
        ...
        elif agent in pseudo_AGENT_TRAIN_FORMAT:
            train_format = COMMON_TRAIN_FORMAT + pseudo_AGENT_TRAIN_FORMAT[agent]
            self._train_mg = MetersGroup(os.path.join(log_dir, 'train'),
                                         formating=train_format)
            self._eval_mg = MetersGroup(os.path.join(log_dir, 'eval'),
                                        formating=COMMON_EVAL_FORMAT)
